    ...
    switch (type) {
      case 'website':
        return {
          ...
          potentialAction: {
            ...
            target: {
              '@type': 'EntryPoint',
              urlTemplate: 'https://www.dayhot.top/search?q={search_term_string}',
            },
      ...
      case 'organization':
        return {
          ...
          name: 'AI每日热点',
          url: 'https://www.dayhot.top',
        logo: 'https://www.dayhot.top/logo.png',
          description: '人工智能资讯聚合平台',
          sameAs: [
            'https://twitter.com/aidayhot',
            'https://github.com/echovic/aidayhot',
          ],
          contactPoint: {
            '@type': 'ContactPoint',
            contactType: 'customer service',
            email: 'echovic007@163.com',
      ...
      case 'newsarticle':
        return {
          ...
          image: data.image || 'https://www.dayhot.top/og-image.png',
          ...
          publisher: {
            ...
            logo: {
              '@type': 'ImageObject',
              url: 'https://www.dayhot.top/logo.png',
            },
          },
          mainEntityOfPage: {
            '@type': 'WebPage',
            '@id': data.url || 'https://www.dayhot.top',
          },
